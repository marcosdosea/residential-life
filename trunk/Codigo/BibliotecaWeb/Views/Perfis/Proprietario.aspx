...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Models.App_GlobalResources.Mensagem.proprietarios %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Models.App_GlobalResources.Mensagem.proprietarios%></h2>
<p>
    <%: Html.ActionLink( Models.App_GlobalResources.Mensagem.novoProprietario, "DefinirProprietario", "Perfis") %>
</p>
<table id="table">
    <tr>
        <th>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.remover, "RemoverProprietario", "Perfis", new { idPessoa = item.IdPessoa, 
