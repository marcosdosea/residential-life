...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Models.App_GlobalResources.Mensagem.definirProfissional %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Models.App_GlobalResources.Mensagem.definirProfissional %></h2>
...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        <legend><%: Models.App_GlobalResources.Mensagem.profissional %></legend>
