...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Models.App_GlobalResources.Mensagem.definirVisitante %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Models.App_GlobalResources.Mensagem.definirVisitante %></h2>
...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        <legend><%: Models.App_GlobalResources.Mensagem.visitante %></legend>
...
<div>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.voltar, "Visitante", "PessoaMoradia")%>
</div>
