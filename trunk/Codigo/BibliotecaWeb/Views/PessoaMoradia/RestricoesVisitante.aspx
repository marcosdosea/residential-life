...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.removerRestricao, "RemoverRestricaoAcessoVisitante", "PessoaMoradia",
...
<div>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.voltar, "Visitante")%>
</div>
</asp:Content>
