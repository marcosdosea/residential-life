...
<p>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.novaRestricao, "NovaRestricaoProfissional", "PessoaMoradia")%>
</p>
<table id="table">
    <tr>
        <th>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.removerRestricao, "RemoverRestricaoAcessoProfissional", "PessoaMoradia",
...
<div>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.voltar, "Profissional")%>
</div>
</asp:Content>
