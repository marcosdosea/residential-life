...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Models.App_GlobalResources.Mensagem.definirMorador %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Models.App_GlobalResources.Mensagem.definirMorador%></h2>
...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        <legend><%: Models.App_GlobalResources.Mensagem.morador %></legend>
...
<div>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.voltar, "Morador", "PessoaMoradia")%>
</div>
