...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <%: Models.App_GlobalResources.Mensagem.apagarEnquete %></h2>
    <h3>
        <%: Models.App_GlobalResources.Mensagem.confirmacaoApagarEnquete %></h3>
    <fieldset>
        <legend>
            <%: Models.App_GlobalResources.Mensagem.apagar %></legend>
        <div class="display-label">
            <%: Models.App_GlobalResources.Mensagem.criador %></div>
        ...
        <div class="display-label">
            <%: Models.App_GlobalResources.Mensagem.dataInicioEnquete%></div>
        <div class="display-field">
            <%: Html.DisplayFor(model => model.DataInicio) %>
        </div>
        <div class="display-label">
            <%: Models.App_GlobalResources.Mensagem.dataFimEnquete %></div>
        <div class="display-field">
