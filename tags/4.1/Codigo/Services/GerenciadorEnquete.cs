...
namespace Services
{
    public class GerenciadorEnquete
    {
        ...
        private IQueryable<EnqueteModel> GetQuery()
        {
            ...
            var query = from enquete in tb_enquete
                        select new EnqueteModel
                        {
                            ...
                            StatusEnquete = (enquete.StatusEnquete == "EmVotacao") ? Models.EnqueteModel.ListaStatusEnquente.EmVotacao :
                                (enquete.StatusEnquete == "Pausada") ? Models.EnqueteModel.ListaStatusEnquente.Pausada :
                                Models.EnqueteModel.ListaStatusEnquente.Finalizada,

                            NomePessoa = enquete.tb_pessoa.Nome,
        ...
        private void Atribuir(EnqueteModel enqueteModel, tb_enquete enqueteE)
        {
            ...
            enqueteE.StatusEnquete = enqueteModel.StatusEnquete.ToString();
