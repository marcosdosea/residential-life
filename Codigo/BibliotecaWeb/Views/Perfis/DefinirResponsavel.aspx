...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Models.App_GlobalResources.Mensagem.definirResponsavel %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Models.App_GlobalResources.Mensagem.definirResponsavel%></h2>
...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        <legend><%: Models.App_GlobalResources.Mensagem.responsavel %></legend>
...
<div>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.voltar, "Responsavel", "Perfis")%>
</div>
