...
<p>
    <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.alocar, "Create")%> &nbsp <%: Html.ActionLink(Models.App_GlobalResources.Mensagem.gerarRelatorio, "ReportPessoaMoradia")%>
</p>
<table id="table">
    <tr>
        <th>
